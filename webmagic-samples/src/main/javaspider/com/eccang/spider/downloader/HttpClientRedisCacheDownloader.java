...
@Service
@ThreadSafe
public class HttpClientRedisCacheDownloader extends AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        mLogger.info("downloading page {}", request.getUrl());
        ...
        try {
            ...
            if (StringUtils.isNotEmpty(html)) {
                ...
                if (statusAccept(acceptStatCode, statusCode)) {
                    ...
                    mLogger.warn("get page {} error, status code {} ", request.getUrl(), statusCode);
                    return null;
                }
            }
        } catch (IOException e) {
            mLogger.warn("download page {} error", request.getUrl(), e);
            ...
            try {
                ...
                mLogger.warn("close response fail", e);
            }
        }
    }
    ...
    protected String getContent(String charset, HttpResponse httpResponse) throws IOException {
        if (charset == null) {
            ...
            if (htmlCharset != null) {
                ...
                mLogger.warn("Charset autodetect failed, use {} as charset. Please specify charset in Site.setCharset()", Charset.defaultCharset());
    ...
    protected String getHtmlCharset(HttpResponse httpResponse, byte[] contentBytes) throws IOException {
        ...
        if (StringUtils.isNotBlank(charset)) {
            mLogger.debug("Auto get charset: {}", charset);
            return charset;
        }
