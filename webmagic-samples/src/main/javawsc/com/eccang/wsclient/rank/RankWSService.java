 ...
 * 
 */
@WebServiceClient(name = "RankWSService", targetNamespace = "http://rank.cxf.eccang.com/", wsdlLocation = "http://localhost:8080/eccang/ws/rank?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(value + "/" + productName + "/ws/rank?wsdl");
        } catch (Exception ex) {
